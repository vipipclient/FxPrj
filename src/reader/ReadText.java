...
public class ReadText {
    public static  void main(String args[]){
        ...
        String TextFileDirectory = args[0];
        String OutputWordsDirectory = args[1];
        ...
        try (SeekableByteChannel fChan = Files.newByteChannel(Paths.get(TextFileDirectory)))
        {
            System.out.println("fChan.size()" + fChan.size());
            in =  new String(Files.readAllBytes(Paths.get(TextFileDirectory)));
